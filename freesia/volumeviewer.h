...
struct OutputImageData{
    ...
    OutputImageData():imageData(nullptr),modelData(nullptr),selectModelData(nullptr){}
};
...
public:
    ...
    void setBuffer(char *buffer,const cv::Point3i &volumeSize,const cv::Point3d &voxelSize);

...
StackSlider::StackSlider():m_fps(8),m_state(States::FREE)
{
    ...
    lyt->setMargin(0);lyt->setSpacing(0);lyt->setContentsMargins(0,0,0,0);
    ...
    m_slider->setMaximumHeight(20);m_slider->setFocusPolicy(Qt::NoFocus);
...
void StackSlider::moveSliderRelative(int v){setValueSimple(m_slider->value()+v);}
